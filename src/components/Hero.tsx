...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center pt-20 px-6 relative overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-100 bg-zinc-800/20 blur-[120px] rounded-full -z-10 pointer-events-none"></div>
    </section>
  );
}
